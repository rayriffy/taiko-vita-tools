namespace GXTConvert.Conversion
{
    public static class PostProcessing
    {
        ...
        private static int GetTilePixelOffset(int t, int x, int y, int width, ColorUtilities.PixelFormat pixelFormat)
        {
            return (GetTilePixelIndex(t, x, y, width) * ColorUtilities.GetBytesPerPixel(pixelFormat));
        }

        public static byte[] UntileTexture(byte[] pixelData, int width, int height,
            ColorUtilities.PixelFormat pixelFormat)
        {
        ...
        public static byte[] UnswizzleTexture(byte[] pixelData, int width, int height,
            ColorUtilities.PixelFormat pixelFormat)
        {
